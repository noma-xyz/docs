...
On noma, you can trade prediction markets from Polymarket, Kalshi, and Limitless — all from one interface, with zero fees.
...
<CardGroup cols={2}>
  ...
  <Card title="Where does the liquidity come from?" icon="building-columns" href="/predict/providers">
    Polymarket, Kalshi, and Limitless — how noma aggregates markets from multiple providers.
  </Card>
</CardGroup>
