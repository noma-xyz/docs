...
- **Display multi-provider badges** — so you know a market is available on Polymarket, Kalshi, Limitless, or any combination
...
- The market detail page shows **orderbooks from all matched providers** when available
...
<Card title="See all providers" icon="building-columns" href="/predict/providers">
  Polymarket, Kalshi, Limitless — how each provider works and what KYC unlocks.
</Card>
