...
The **Activity** tab on a market page shows all recent trading activity across that market — not just yours.

To view your personal order history, go to your **Dashboard** and open the **History** tab. This shows:
