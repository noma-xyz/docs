...
Kalshi is a US-regulated exchange for event contracts, supervised by the CFTC — covering politics, economics, sports, weather, and more with hundreds of active markets. Noma accesses Kalshi markets through **DFlow**, which brings Kalshi's orderbook on-chain via Solana.
